...
# In-memory user settings: {user_id: {'exchange': str, 'buy_rate': float, 'sell_rate': float, 'max_volume': float}}
user_settings = {}
    ...
    try:
        while True:
            ...
            for user_id, settings in user_settings.items():
                ...
                # Fetch price to buy on user exchange
                try:
